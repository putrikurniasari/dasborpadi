<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html" class="flex items-center gap-3 flex-nowrap">
            <span class="logo flex items-center gap-2 whitespace-nowrap flex-nowrap"
                :class="sidebarToggle ? 'hidden' : ''">

                <!-- Logo Light Mode -->
                <img class="dark:hidden h-7 w-auto" src="{{ asset('images/logo/logoumkm.svg') }}" alt="Logo" />

                <!-- Logo Dark Mode -->
                <img class="hidden dark:block h-7 w-auto" src="{{ asset('images/logo/logoumkm.svg') }}" alt="Logo" />
            ...
            <!-- Logo icon kecil saat sidebar mengecil -->
            <img class="logo-icon h-7 w-auto" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="{{ asset('images/logo/logoumkm.svg') }}" alt="Logo" />
        </a>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                            ...
                            :class=" (selected === 'Dashboard') || (page === 'dashboardmain' || page === 'dashboardgrafik') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Dashboard') || (page === 'dashboardmain' || page === 'dashboardgrafik') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')"
                                class="menu-item group"
                                :class="(selected === 'Tables') || (page === 'uploadrealisasi' || page === 'uploadtransaksi') ? 'menu-item-active' : 'menu-item-inactive'">
                                <svg :class="(selected === 'Tables') || (page === 'uploadrealisasi' || page === 'uploadtransaksi') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="translate transform overflow-hidden"
                                ...
                                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                    class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                    <li>
                                        <a href="{{ route('excel.realisasi_umkm') }}" class="menu-dropdown-item group"
                                            :class="page === 'uploadrealisasi' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                            Realisasi Padi UMKM
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('excel.pembelian_padi') }}" class="menu-dropdown-item group"
                                            :class="page === 'uploadtransaksi' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                            Pembelian Padi
                                        </a>
                                    </li>
                                </ul>

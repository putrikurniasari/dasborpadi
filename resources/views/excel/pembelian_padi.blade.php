...
@endphp
@section('page', 'uploadtransaksi')
@section('content')
    <main>
        <div class="space-y-6 p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            <!-- Judul Halaman -->
            <div x-data="{ pageName: `Excel Pembelian Padi UMKM` }" class="mb-4">
                                    ...
                                    <div
                                        ...
                                        <div class="px-5 py-4 sm:px-6 sm:py-5 flex items-center justify-between">
                                            <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                                                Daftar File Pembelian Padi UMKM
                                            </h3>
                                                                    ...
                                                                    <td class="px-5 py-4 sm:px-6">
                                                                        <div class="d-flex flex-column gap-2">
                                                                            ...
                                                                            <form id="delete-form-{{ $file->id }}"
                                                                                action="{{ route('delete.transaksi', $file->id) }}"
